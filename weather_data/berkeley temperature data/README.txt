File Generated: 02-Feb-2012 01:26:30
Dataset Collection: World Weather Records
Type: TAVG - Monthly
Version: LATEST
Number of Records: 1860
Number of Locations: 1860
Number of Data Points: 206384
Dataset Hash: ece35437b3d70e2c533f845ca07605cb

------------------------------------

This is the dataset description for the "World Weather Records" dataset as 
represented in the Berkeley Earth Surface Temperature Analysis data archive.

World Weather Records RAW DATA

This dataset is a representation of the land surface temperature component of 
the World Weather Records (WWR).  The official dataset is maintained by NOAA in 
collaboration with the World Meteorological Organization.

The original data files can be found via:
http://www.ncdc.noaa.gov/oa/wdc/index.php?name=worldweatherrecords
...
Note: Only WWR series 6 - 9 are currently included.  These data set may include 
information for any time period, but primarily include 1961 and later.
